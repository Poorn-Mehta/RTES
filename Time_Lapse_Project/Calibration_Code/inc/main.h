...
#define Useless_Frames		10
#define Test_Frames		90

#define Pix_Allowed_Val		6
#define Pix_Max_Val		255
#define Pix_Min_Val		0

#define Diff_Thr_Low		(float)(0.35)
#define Diff_Thr_High		(float)(0.55)
