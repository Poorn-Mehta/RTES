...
int main(void)
{
    ...
    printf("Ex-10 U=%4.2f (C1=1, C2=1, C3=1, C4=2; T1=2, T2=5, T3=7, T4=14; T=D): ",
		   ((1.0/2.0) + (1.0/5.0) + (1.0/7.0) + (2.0/14.0)));
	numServices = sizeof(ex10_period)/sizeof(U32_T);
    if(completion_time_feasibility(numServices, ex10_period, ex10_wcet, ex10_period) == TRUE)
        printf("FEASIBLE\n");
    else
        printf("INFEASIBLE\n");

    printf("Ex-11 U=%4.2f (C1=1, C2=2, C3=3; T1=3, T2=6, T3=9; T=D): ",
		   ((1.0/3.0) + (2.0/6.0) + (3.0/9.0)));
	numServices = sizeof(ex11_period)/sizeof(U32_T);
