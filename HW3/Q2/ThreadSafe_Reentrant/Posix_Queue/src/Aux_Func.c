...
float Time_Stamp(void)
{
	...
	if(curr_time.tv_nsec >= start_time.tv_nsec)
		rval = ((curr_time.tv_sec - start_time.tv_sec) * 1000000) + (((float)(curr_time.tv_nsec - start_time.tv_nsec)) / 1000);
	else
		rval = ((curr_time.tv_sec - start_time.tv_sec - 1) * 1000000) + (((float)(1000000000 - (start_time.tv_nsec - curr_time.tv_nsec))) / 1000);
